...
def get_change(budget, exchanging_value):
    ...
    """
    left_value = budget - exchanging_value
    return left_value
...
def get_value_of_bills(denomination, number_of_bills):
    ...
    rounded_value_of_bills = int(value_of_bills + 0.5)
    return rounded_value_of_bills
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    number_of_bills=budget/new_exchange_rate
    final_number_of_bills = number_of_bills-(number_of_bills%denomination)
    return final_number_of_bills
